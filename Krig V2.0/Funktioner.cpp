...
void krig(int deck1[], int deck2[], int temp1[], int temp2[])
{
	...
	{
		// Joker mod 2'er
		if ((deck1[k] == 15) && (deck2[l] == 2))
		{
		cout << "Player 2 wins - Og player 1 mistede en joker!" << endl;
		temp2[y] = deck1[k];
		deck1[k] = 0;
		y++;
		k++;
		...
		{
		cout << "Player 1 wins - Og player 2 mistede en joker!" << endl;
		temp1[x] = deck2[l];
		deck2[l] = 0;
		x++;
		k++;
		...
		else if ((deck1[k] > deck2[l]) && (deck2[l] > 0))
		{
	...
	cout << "P1: " << winP1 << endl << "P2: " << winP2 << endl << "Ties: " << tie << endl << endl;
}
...
bool checkWin(int deck1[], int deck2[])
{
	...
	if (counter1 > 55)
	{
		cout << "Player 1 wins!" << endl << "Total moves: " << totalMoves << endl << endl;
		return true;
	}
	else if (counter2 > 55)
	{
		cout << "Player 2 wins!" << endl << "Total moves: " << totalMoves <<  endl  << endl;
		return true;
	}
	else
	{
